...
<div class="demo-card demo-card-wide">
    ...
    <div class="result-data">
        <div class="result-data-row"><span class="result-data-label">Логін</span><span class="result-data-value"><?= htmlspecialchars($data['login'] ?? '') ?></span></div>
        <div class="result-data-row"><span class="result-data-label">Стать</span>
            <span class="result-data-value">
                <?php $genderMap=['male'=>'Чоловіча','female'=>'Жіноча']; echo htmlspecialchars($genderMap[$data['gender'] ?? '']??'Не вказано'); ?>
            </span>
        </div>
        <div class="result-data-row"><span class="result-data-label">Місто</span><span class="result-data-value"><?= htmlspecialchars($data['city']??'') ?></span></div>
        <div class="result-data-row"><span class="result-data-label">Хобі</span>
            <span class="result-data-value">
                <?php
                ...
                } else { echo 'Не вказано'; }
                ?>
            </span>
        </div>
        <div class="result-data-row"><span class="result-data-label">Про себе</span>
    ...
    <div class="flex-buttons" style="margin-top:20px;">
        <a href="task10_form.php" class="btn-submit" style="text-decoration:none;color:white;">Перейти до форми</a>
    </div>
    <?php endif; ?>
</div>
<?php
