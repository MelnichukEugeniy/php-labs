...
<div class="success-page">
    <div class="alert alert--success">
        ...
        <p>Ласкаво просимо до інтернет-магазину мотоциклів, <strong><?= htmlspecialchars($regData['login'] ?? '') ?></strong>!</p>
        <p>Тепер ви можете зберігати улюблені моделі та оформлювати замовлення.</p>
    </div>
