<?php
/**
 * Shared layout template for LR3 Variant 13 task pages
 */
...
function renderVariantLayout(string $content, string $taskName, string $bodyClass = ''): void
{
    ...
    $demoUrl = "/lr3/demo/{$currentTask}?from=v13";
    ?>
<!DOCTYPE html>
<html lang="uk">
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($taskName) ?> — Варіант 13 ЛР3</title>
    <link rel="stylesheet" href="<?= webPath(dirname(__DIR__, 3) . '/shared/css/base.css') ?>">
    <link rel="stylesheet" href="<?= webPath(__DIR__ . '/demo.css') ?>">
</head>
...
<body class="body-with-header <?= htmlspecialchars($bodyClass) ?>">
    <header class="header-fixed">
        ...
        <div class="header-right">
            <span class="header-variant-label">В-13</span>
